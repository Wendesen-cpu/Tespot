function requirment_search(origin,destination){
    fetch(`https://sandbox.travelperk.com/travelsafe/restrictions?origin=${origin}&destination=${destination}&origin_type=country_code&destination_type=country_code&date=2021-2-28`, {
           method: 'GET',
           headers: {
               'Api-Version': '1',
